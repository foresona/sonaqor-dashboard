...
export default function WebhooksPage() {
  ...
  const [eventCategoryFilter, setEventCategoryFilter] = useState<'all' | string>('all')
  ...
  const filteredEvents = useMemo(() => {
    ...
    if (eventSearchQuery) {
      filtered = filtered.filter(
        (event) =>
          ...
          event.desc.toLowerCase().includes(eventSearchQuery.toLowerCase()),
      )
    }
    ...
    return filtered
  }, [eventSearchQuery, eventCategoryFilter])
        ...
        >
          {[
            ...
            <button
              key={tab.id}
              onClick={() =>
                setActiveTab(tab.id as 'configuration' | 'logs' | 'events' | 'examples')
              }
              style={{
                padding: '12px 20px',
              ...
              >
                ...
                <div style={{ marginBottom: '24px' }}>
                  ...
                  >
                    ...
                    <strong style={{ color: 'white' }}>{selectedWebhook.name}</strong> to verify
