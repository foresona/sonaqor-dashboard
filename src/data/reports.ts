  ...
  return {
    templates: [
      ...
      },
      {
        ...
        description: 'Analyze transaction patterns, volumes, and trends over time',
        type: 'Usage',
        parameters: [
          {
            name: 'Date Range',
          ...
          },
          {
            ...
            type: 'multiselect',
            options: ['Credit', 'Debit', 'Transfer', 'All'],
            required: false,
          },
          {
            name: 'Minimum Amount',
      ...
      {
        id: '7',
        name: 'Customer Insights Export',
        description: 'Bulk export of customer personas, risk scores, and behavioral data',
        type: 'Custom',
        parameters: [
          {
            name: 'Date Range',
    ...
    reports: [
      ...
      },
      {
        id: '5',
        templateId: '6',
        name: 'Transaction Volume Analysis - September 2024',
        status: 'Completed',
        createdAt: '2024-10-20 11:30',
        completedAt: '2024-10-20 11:34',
        downloadUrl: '/reports/transaction-vol-sep-2024.csv',
        format: 'CSV',
        size: '856 KB',
      },
      {
        id: '6',
        templateId: '7',
        name: 'Customer Insights Export - High Risk',
        status: 'Completed',
        createdAt: '2024-10-19 16:00',
        completedAt: '2024-10-19 16:07',
        downloadUrl: '/reports/customer-insights-high-risk.json',
        format: 'JSON',
        size: '1.2 MB',
      },
      {
        id: '7',
        templateId: '2',
        name: 'Persona Distribution - October 2024',
        status: 'Completed',
        createdAt: '2024-10-18 13:20',
        completedAt: '2024-10-18 13:27',
        downloadUrl: '/reports/persona-dist-oct-2024.xlsx',
        format: 'Excel',
        size: '2.1 MB',
      },
      {
        id: '8',
        templateId: '1',
        name: 'API Usage - September 2024',
        status: 'Failed',
        createdAt: '2024-10-17 10:00',
        format: 'PDF',
      },
    ],
    schedules: [
